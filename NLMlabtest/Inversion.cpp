...
void rungeKutta() {
  ...
  switch (choice) {
  case 1:
    f = [a, b](double x, double y) { return a * sin(b * x); };
    break;
  case 3:
    f = [a, b](double x, double y) { return a * sin(b * x) + a * cos(b * x); };
    break;
  case 4:
    f = [a](double x, double y) { return a * exp(x); };
    break;
  case 5:
    cout << "Enter the power n: ";
    cin >> p;
    f = [a, b, p](double x, double y) { return a * pow(x, p) + b * pow(y, p); };
    break;
  default:
